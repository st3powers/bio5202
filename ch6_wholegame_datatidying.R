...
#> # A tibble: 500 × 9
#>   org_pac_id org_nm           measure_title   CAHPS…¹ CAHPS…² CAHPS…³ CAHPS…⁴
...
#> # … with 494 more rows, 2 more variables: CAHPS_GRP_8 <dbl>,
#> #   CAHPS_GRP_12 <dbl>, and abbreviated variable names ¹​CAHPS_GRP_1, …
